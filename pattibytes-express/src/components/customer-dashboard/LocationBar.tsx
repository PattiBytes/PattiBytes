...
export default function LocationBar({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-3 sm:p-4 md:p-5">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 pb-3 sm:pb-4 border-b">
        ...
        <div className="flex flex-wrap gap-2 sm:flex-nowrap sm:gap-2.5 sm:justify-end">
          <button
            type="button"
          ...
          <button
            type="button"
            onClick={onOpenSaved}
            className="px-3 py-2 bg-gray-100 text-gray-800 rounded-xl hover:bg-gray-200 text-xs sm:text-sm font-semibold"
          >
            Saved
          </button>
        </div>
