        ...
        {filteredRecentOrders.slice(0, 6).map((order) => (
          ...
          >
            <div className="min-w-0">
              ...
              <p className="text-xs text-gray-600 truncate">{order.customer_name || 'Unknown'}</p>
    ...
    <div className="space-y-2">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-900">Create Orders</span>
        </div>
        <div className="mt-1 text-xs text-gray-600 flex items-center gap-2">
          Create New Orders <Eye size={14} />
        </div>
      </button>
      ...
      >
        <div className="flex items-center gap-2">
          <Users className="text-primary" size={18} />
          <span className="font-semibold text-gray-900">Manage Custom Products</span>
        </div>
        <div className="mt-1 text-xs text-gray-600 flex items-center gap-2">
         Manage custom products <Eye size={14} />
        </div>
      </button>
      ...
      <button
        onClick={() => router.push('/admin/cabs')}
        className="w-full bg-gray-50 hover:bg-gray-100 rounded-xl p-3 text-left border"
      >

        <div className="flex items-center gap-2">
          <TrendingUp className="text-primary" size={18} />
          <span className="font-semibold text-gray-900">Open Cabs/Taxi</span>
        </div>
        <div className="mt-1 text-xs text-gray-600">
         Taxi,Cabs, drivers
        </div>
