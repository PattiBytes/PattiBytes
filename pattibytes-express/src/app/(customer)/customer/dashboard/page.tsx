...
export default function CustomerDashboardPage() {
  ...
  const { location, loading: locationLoading, getCurrentLocation, setLocation } = useLocation();
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 py-3 sm:py-4 md:py-6">
          ...
          <div className="bg-gradient-to-r from-orange-500 via-pink-500 to-purple-500 rounded-xl md:rounded-2xl shadow-lg md:shadow-2xl p-4 md:p-6 mb-4 md:mb-6 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h1 className="text-lg md:text-2xl lg:text-3xl font-bold mb-1 leading-tight">
                Welcome, {user?.full_name?.split(' ')[0] || 'Food Lover'}! 👋
              </h1>
          ...
          <div className="bg-white rounded-xl md:rounded-2xl shadow-lg p-3 md:p-4 lg:p-6 mb-4 md:mb-6">
                    ...
                    >
                      {result.type === 'restaurant' ? (
                        <>
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-semibold text-gray-900 text-sm md:text-base truncate">{result.business_name}</p>
                        ...
                        <>
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="font-semibold text-gray-900 text-sm md:text-base truncate">{result.name}</p>
                            <p className="text-xs md:text-sm text-gray-600 truncate">
            ...
            {!searchQuery && (
              <div className="mt-3 md:mt-4 flex gap-2 overflow-x-auto scrollbar-hide">
                ...
                {['Paneer', 'Biryani', 'Pizza', 'Chinese', 'Desserts', 'Burger', 'Momos', 'Pasta'].map((hint) => (
                  <button
                    key={hint}
          ...
          <div className="mb-4 md:mb-6">
            <h2 className="text-base md:text-lg lg:text-xl font-bold text-gray-900 mb-1">
              {selectedFilter === 'all' ? 'All Restaurants Near You' : `${selectedFilter.charAt(0).toUpperCase() + selectedFilter.slice(1)} Restaurants`}
            </h2>
            <p className="text-xs md:text-sm text-gray-600">{filteredRestaurants.length} restaurants found</p>
          </div>
          ...
          {loading ? (
            <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-4 lg:gap-6">
              {[...Array(8)].map((_, i) => (
                <div key={i} className="bg-gray-200 h-56 md:h-64 lg:h-72 rounded-xl md:rounded-2xl animate-pulse" />
              ))}
            </div>
                ...
                >
                  ...
                  <div className="p-2 md:p-3 lg:p-4">
                    ...
                    <div className="flex items-center gap-1 text-xs md:text-sm text-gray-600 mb-2 md:mb-3">
                      ...
                      <span className="font-medium truncate">{restaurant.distance.toFixed(1)} km</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs md:text-sm pt-2 md:pt-3 border-t">
                      ...
                      <div className="flex items-center gap-0.5 text-gray-600">
                        ...
                        <span className="font-medium whitespace-nowrap text-[10px] md:text-xs">30-40 min</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center py-12 md:py-16 bg-white rounded-xl md:rounded-2xl shadow-lg">
              ...
              <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-2">No restaurants found</h3>
              <p className="text-sm md:text-base text-gray-600 mb-6 px-4">Try a different filter or update your location</p>
              <button
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                      ...
                      <MapPin className={`w-5 h-5 ${address.is_default ? 'text-white' : 'text-gray-600 group-hover:text-primary'}`} />
                    </div>
                    <div className="flex-1 min-w-0">
