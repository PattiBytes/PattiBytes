...
export default function AddressPickerModal({ visible, addresses, selectedId, onSelect, onClose, onAddNew }: Props) {
  return (
      ...
      <View style={S.overlay}>
        <View style={S.sheet}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
            <Text style={{ fontSize: 17, fontWeight: '900', color: '#111827' }}>Select Delivery Address</Text>
            ...
            {addresses.map(a => {
              ...
              return (
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={{ fontWeight: '800', color: '#111827', fontSize: 14 }}>{a.label}</Text>
                    {!!a.recipient_name && (
...
const S = StyleSheet.create({
  ...
  row:          { flexDirection: 'row', alignItems: 'flex-start', gap: 12, padding: 14, borderRadius: 14, borderWidth: 1.5, borderColor: 'transparent', marginBottom: 8, backgroundColor: '#F9FAFB' },
  rowActive:    { borderColor: COLORS.primary, backgroundColor: '#FFF3EE' },
  icon:         { width: 40, height: 40, borderRadius: 10, backgroundColor: '#F3F4F6', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  check:        { width: 24, height: 24, borderRadius: 12, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
